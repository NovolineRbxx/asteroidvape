--[[
  ...
  ___   _____ _____ ___________ _____ ___________  ______ ___________ _    _  ___  ______  _____ 
 / _ \ /  ___|_   _|  ___| ___ \  _  |_   _|  _  \ | ___ \  ___|  _  \ |  | |/ _ \ | ___ \/  ___|
/ /_\ \\ `--.  | | | |__ | |_/ / | | | | | | | | | | |_/ / |__ | | | | |  | / /_\ \| |_/ /\ `--. 
|  _  | `--. \ | | |  __||    /| | | | | | | | | | | ___ \  __|| | | | |/\| |  _  ||    /  `--. \
| | | |/\__/ / | | | |___| |\ \\ \_/ /_| |_| |/ /  | |_/ / |___| |/ /\  /\  / | | || |\ \ /\__/ /
\_| |_/\____/  \_/ \____/\_| \_|\___/ \___/|___/   \____/\____/|___/  \/  \/\_| |_/\_| \_|\____/ 
...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/NovolineRbxx/asteroidvape/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
		assert(suc, res)
...
do
	...
	local textlabel = Instance.new("TextLabel")
	textlabel.Size = UDim2.new(1, 0, 0, 36)
	textlabel.Text = "credits to copium/luc!"
	textlabel.BackgroundTransparency = 1
	textlabel.ZIndex = 10
	textlabel.TextStrokeTransparency = 0
